...
CLI = CommandLineInterface(
    "loawatcher",
    "python -m loawatcher [OPTIONS]",
    "Initialize the Watcher server."
)
...
GENERAL_GROUP.add_argument(
    ...
    version="Watcher server {}".format(__version__))


# Contrib module options.
...
NETWORKING_GROUP.add_argument(
    ...
    help="Port to bind the UDP listener to")
...
# performed after all contrib modules are loaded.
